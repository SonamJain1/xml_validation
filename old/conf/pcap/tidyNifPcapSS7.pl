...
tidy_pickup("/opt/engine/pcap/pickup/pickupSS7", 2);      # delete old files if get > 1G, the number 2 here is 2 x GB
...
tidy_blockedpcap("/opt/engine/pcap/pickup/pickupSS7/blockedpcaps", 50000);        # delete old files if more than 50,000
